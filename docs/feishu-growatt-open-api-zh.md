...
<image token="RJPdbAGddoX1LvxRI6Rc2Amondf" width="553" height="391" align="center"/>
...
<image token="LrO3bJsQ1oYwBwxXGLecl52fnBh" width="967" height="678" align="left"/>
...
请求参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_F58Ogq"/>
...
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_WrZt9t"/>
...
- ContentType：application/x-www-form-urlencoded;
请求参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_BcAZXd"/>
...
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_aGxdM8"/>
...
- <text color="red">仅authorization_code模式下支持</text>
- authFlag为false代表未授权
##### 请求URL
...
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_QE53rl"/>
...
data 参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_QzdH9S"/>
...
##### 请求示例
请求参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_6OHkc5"/>
...
##### 返回示例
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_gqbxmG"/>
...
##### 返回示例
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_NY9nfO"/>
...
data返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_XSQDmP"/>
...
##### 请求示例
请求参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_TXwkZt"/>
...
##### 返回示例
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_lzzT3b"/>
...
Http body参数和说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_waomfD"/>

接口返回参数和说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_Huj5nx"/>
...
Http body参数和说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_AKVdR4"/>

接口返回参数和说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_Tnf0GM"/>
...
- 请求头，必须携带，有效的 access_token，放入请求头中的，Authorization 参数，并且，需要带前缀 Bearer
HTTP 头部参数及说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_LGyprP"/>

HTTP Body 参数及说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_IMGuUC"/>

接口返回参数和说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_uZJKFC"/>
...
data 参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_5kLYHc"/>
...
- 请求头，必须携带，有效的 access_token，放入请求头中的，Authorization 参数，并且，需要带前缀 Bearer
HTTP 头部参数及说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_iewtbH"/>

HTTP Body 参数及说明：
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_srjhbN"/>

接口返回参数和说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_HWl6nI"/>
...
返回参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_71dj4m"/>
...
参数说明
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_UqiZ4B"/>
...
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_8ifm36"/>
...
<sheet token="YKJAskc9QhveoItPncOcj1k6n2c_iQxQ7G"/>


## 5.附件

### 测试报告
<mention-doc token="WkkZwLyuDi0Dbyk31AlcXUe7nGh" type="wiki">oauth2-openApi平台接口测试报告</mention-doc>
### Evergen相关文档
<mention-doc token="Gcvcs3YwFhrkcetfxurcMHSIn3c" type="sheet">Evergen命令对齐表</mention-doc>
<mention-doc token="Vq4vwZKy0iyTtTkUhPfcderhnGf" type="wiki">MIN-XH or XH2_Evergen_ API(2)</mention-doc>
