...
| 日期 | 变更说明 |
| :--- | :--- |
| `2026-07-27` | 1) 调整文档结构：将 VPP 集成排除范围移至独立章节 4，原章节 4-5 依次重编号为 5-6；2) 扩充 MODA 系列机型：在 AIO-002 中添加 MODA 10-15KTL3 H 和 MODA 10-15KTL3 HU，统一命名格式；3) 添加储能一体机支持：新增 3.2 节"储能一体机"，包含 MINA 和 MODA 系列；型号分组数从 10 更新为 12 |
