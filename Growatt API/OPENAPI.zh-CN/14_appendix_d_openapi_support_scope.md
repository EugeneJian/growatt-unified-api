...
| AIO-002 | MODA | `MODA 4-15KTL3 HU` `MODA 10-15KTL3 H` `MODA 10-15KTL3 HU` | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | 无 |
...
| 日期 | 变更说明 |
| :--- | :--- |
| `2026-07-27` | 调整文档结构：将 VPP 集成排除范围移至独立章节 4，原章节 4-5 依次重编号为 5-6 |
| `2026-07-27` | 扩充 MODA 系列机型：在 AIO-002 中添加 MODA 10-15KTL3 H 和 MODA 10-15KTL3 HU，统一命名格式 |
| `2026-07-27` | 添加储能一体机支持：新增 3.2 节"储能一体机"，包含 MINA 和 MODA 系列；型号分组数从 10 更新为 12 |
| `2026-07-23` | 添加 VPP 集成排除范围说明：明确 SPA/WIT/WIS 系列及纯光伏逆变器不支持 VPP 调度 |
